...
func (h *Helper[V]) Slice(s string) ([]*RequestParamItem[string], error) {
	paramPairs := h.Raw()
...
func (h *Helper[V]) FileSlice(s string) ([]*RequestParamItem[*File], error) {
	paramPairs := h.Raw()
	if paramPairs.ContainsKey(s) {
...
func (h *Helper[V]) File(s string) (*File, error) {
	paramPairs := h.Raw()
	if paramPairs.ContainsKey(s) {
